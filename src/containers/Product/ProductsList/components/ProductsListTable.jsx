...
const columns = ['Id', 'Strain Name', 'Weight IN', 'Weight', 'Price By Weight', 'Category', 'Batch Serial NO#', 'Edit', 'Label', 'Delete'];
    ...
    await axios.get(url, {
      ...
      if (!response.data.error) {
        ...
        for (let i = 0; i < response.data.products.length; i += 1) {
          ...
          const lurl = `/products/labels/${response.data.products[i].id}`;
          rows.push({

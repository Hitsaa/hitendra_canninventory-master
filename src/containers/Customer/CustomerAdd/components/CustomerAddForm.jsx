...
class CustomerAddForm extends PureComponent {
  ...
  async handleSubmit(e) {
    ...
    if (firstName && lastName && phoneNumber && dob && zip && city
      ...
      bodyFormData.append('patientType', patientType.value);
  ...
  render() {
    ...
    return (
      <form className="form form form--horizontal" onSubmit={this.handleSubmit}>
        ...
        <div className="form__form-group">
          <span className="form__form-group-label">Patient Type</span>
          <div className="form__form-group-field">
            <Field
              name="patient_type"
              ...
              type="text"
              required
              ref={node => (this.inputPatientType = node)}
              options={[
                { value: 'ADULT_PATIENT', label: 'Adult Patient' },
                { value: 'TEMP_ADULT', label: 'Temp Adult' },
                { value: 'MINOR_PATIENT', label: 'Minor Patient' },
                { value: 'TEMP_MINOR', label: 'Temp Minor' },

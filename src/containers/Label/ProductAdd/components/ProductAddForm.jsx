...
import { Button, ButtonToolbar, Cosl } from 'reactstrap';
...
class ProductAddForm extends PureComponent {
  ...
  async handleSubmitGrowProc(e) {
    ...
    const weight = this.inputWeight.value;
    const weightType = this.inputWeightType.value;
    const categoryID = this.inputCategoryID.value;
    const pricePerWeight = this.inputPricePerWeight.value;
    if (weightType && weight && pricePerWeight && categoryID) {
      // eslint-disable-next-line no-console
      const bodyFormData = new FormData();
          ...
          if (isOtherProduct) {
            ...
            type = (
              <form className="form form form--horizontal" onSubmit={this.handleSubmitGrowProc}>
                ...
                <div className="form__form-group">
                  <span className="form__form-group-label">Price Per Weight <span>(USD)</span></span>
                  <div className="form__form-group-field">
                    <Field

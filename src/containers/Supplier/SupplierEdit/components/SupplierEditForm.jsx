...
import { Button, ButtonToolbar, Input,Col } from 'reactstrap';
import { reduxForm } from 'redux-form';
import axios from 'axios';
import createHashHistory from 'history/createHashHistory';

class SupplierEditForm extends PureComponent {
  constructor() {
    super();
    this.state = {
      clientID: '',
        ...
        <form className="form form form--horizontal" ref="testForm" onSubmit={this.handleSubmit}>
          ...
          <div className="form_form-group">
            <ButtonToolbar className="form__button-toolbar">
              <Button color="primary" className="btn-block" type="submit">UPDATE SUPPLIER</Button>
            </ButtonToolbar>
          </div>
          </Col>
        </form>

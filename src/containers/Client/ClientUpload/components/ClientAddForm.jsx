...
class ClientAddForm extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onDrop = (acceptedFiles) => {
    ...
    if (acceptedFiles) {
      ...
      const urls = `${process.env.API_ENDPOINT}/clients/batches/import`;
      axios({
        method: 'post',
        url: urls,
        data: bodyFormData,
  ...
  download() {
    const urls = `${process.env.API_FILE_ENDPOINT}/clients/sample/download`;
  ...
  async handleSubmit(e) {
    ...
    if (file) {
      // eslint-disable-next-line no-console
      const bodyFormData = new FormData();
      bodyFormData.append('name', 'customers');

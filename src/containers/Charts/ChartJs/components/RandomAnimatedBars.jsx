...
class RandomAnimatedBars extends PureComponent {
  ...
  componentDidMount() {
    ...
    const { productData, label } = this.props;
    ...
    newDataSet.backgroundColor = productData.backgroundColor;
    newDataSet.borderColor = productData.borderColor;
    newDataSet.borderWidth = productData.borderWidth;
    newDataSet.hoverBackgroundColor = productData.hoverBackgroundColor;
    newDataSet.hoverBorderColor = productData.hoverBorderColor;

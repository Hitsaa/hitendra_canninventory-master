...
class PlantAddForm extends PureComponent {
  ...
  onDrop = (acceptedFiles) => {
    ...
    if (acceptedFiles) {
      ...
      bodyFormData.append('name', 'plants');
      ...
      const urls = `${process.env.API_ENDPOINT}/plants/batches/import`;
      axios({
        method: 'post',
        url: urls,
        data: bodyFormData,
  ...
  download() {
    const urls = `${process.env.API_FILE_ENDPOINT}/plants/sample/download`;
